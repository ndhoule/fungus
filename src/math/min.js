...
/**
 * Returns the smallest element in a collection. Takes an optional `callback` argument, which `min`
 ...
 * @return {*} The minimum value in the collection, or `Infinity` if the list is empty.
 * @example
 * max([5, 3, 9]);
 * //=> 9
 *
